...
// 设置请求随机图片 api
const apiPichost = 'https://api.zeng.cyou/pichost/api.php';

function randomPic(api) {
...
randomPic(apiPichost)
  .then(pic => {
    if (pic) {
      document.querySelector('.photo-bg').style.backgroundImage = `url('${pic}')`;
    }
  });
